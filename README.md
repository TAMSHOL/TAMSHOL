...
<!---
TAMSHOL/TAMSHOL is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
You can click the Preview link to take a look at your changes.
--->
<!DOCTYPE html>
<html lang="en">
  <!-- 
  Code Made By Nais ID
  Youtube: Nais ID
  Tiktok: @hanizapunyaa
  -->
  <head>
  ...
  <body onload="startTime()">
    ...
    <audio class="audio" src="https://www.mboxdrive.com/Sezairi%20-%20It's%20You.mp3" autoplay type="audio" loop=""></audio>
    <audio class="notif" src="https://www.mboxdrive.com/notif.mp3" type="audio"></audio>
    ...
    <a href="https://www.youtube.com/naisid" class="copyright">
